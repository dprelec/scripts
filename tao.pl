...
# tao.pl - print random quote from The Tao of Programming
# dprelec, 2012-01-25
...
say @txt;
say "-- The Tao of Programming, $title";
...
were unconcerned with appearances. There hair was long and unkempt and
...
My  spirit,  free  to  work without plan, follows its own instinct. In
...
the  work  fill  my  being.  I close my eyes for a moment and then log
off.''
...
but  waste  everyone's  time.  Can I go now? I have a program that I'm
working on."
...
are Yin and I am Yang. If we travel together we will become famous and
